...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/ANGEL-OFC/NovaBot-MD\ncd NovaBot-MD\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/ANGEL-OFC/NovaBot-MD.git
...
echo -e "\033[01;32m\033[01mIniciando NovaBot!!\nStarting NovaBot!!\n\033[0m"
npm start
